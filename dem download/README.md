...
- On the toolbar click on the gear icon, and an option called 'Open Download URL', select it, and the click on where the area of interest is and a URL will be open in the local browser to download a zip file that contains the sensor data, including a DEM. 
